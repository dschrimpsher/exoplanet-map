...
//    private  static final String NASA_EXOPLANET_URL = "http://exoplanetarchive.ipac.caltech.edu/cgi-bin/nstedAPI/nph-nstedAPI?table=exoplanets&where=st_dist%3C500&format=xml&select=pl_radj,pl_name,st_dist,ra,dec,pl_massj,pl_msinij&order=pl_radj";
    private  static final String NASA_EXOPLANET_URL = "http://exoplanetarchive.ipac.caltech.edu/cgi-bin/nstedAPI/nph-nstedAPI?table=exoplanets&where=st_dist%3C8000&format=xml&select=pl_radj,pl_name,st_dist,ra,dec,pl_massj,pl_msinij&order=pl_radj";
