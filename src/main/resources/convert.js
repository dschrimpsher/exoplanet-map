...
function CalcX(JRA, JDec)    // "CalculateX" as a name fails.  Why?
{
    var coun = 0;
    var fieldx;
    var which = 0;
...
// Then fill the calculated values into the output fields.
    ...
    if (which == 1) {
        globalJRA = JRA * 3600.0;
        globalJDec = JDec * 3600.0;
...
// user see our precision or lack thereof.
     ...
     galac = Transform(xradec, JtoG);



    var output  = RadiansPrintD(galac[0])
